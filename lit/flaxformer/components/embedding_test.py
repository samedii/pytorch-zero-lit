...
from lit.flaxformer.components import initializers
...
class MultiEmbedTest(parameterized.TestCase):
    ...
    def test_multi_embed_combines_embeddings_correctly(
        self, method, features, expected_shape
    ):
...
class EmbeddingTest(parameterized.TestCase):
    ...
    def test_add_sinusoidal_position_embs(self):
        ...
        np.testing.assert_array_almost_equal(
            output_embeddings, expected_output_embeddings
        )
    ...
    def test_regression_add_position_embeddings_learned(self):
        ...
        np.testing.assert_allclose(
            ...
            [
                [
                    [
                        4.486782358981145e-07,
                        -3.5457077274259063e-07,
                        1.0727929122822388e-07,
                        1.3890753791656607e-07,
                        -7.792502287884417e-07,
                    ],
                    [
                        -2.3853303332543874e-07,
                        8.467901011499634e-07,
                        -8.650059157844225e-08,
                        3.407756707929366e-07,
                        -2.226069852895307e-07,
                    ],
                    [
                        -1.1156219414942825e-07,
                        -6.10807489920262e-07,
                        1.5079198192324839e-06,
                        1.714607265057566e-07,
                        -1.9881858861481305e-06,
                    ],
                    [
                        2.980690965159738e-07,
                        4.950079102172822e-08,
                        1.9940485174174682e-07,
                        7.134963198041078e-07,
                        1.5179145975707797e-06,
                    ],
                    [
                        7.398467261054975e-08,
                        -4.966278197571228e-07,
                        8.895806757891478e-08,
                        -4.5914887891740364e-07,
                        1.1332289204801782e-06,
                    ],
                    [
                        1.3519083950086497e-06,
                        -1.0249741535517387e-06,
                        -1.1988712458332884e-06,
                        -6.748282288526752e-08,
                        1.18359389489342e-06,
                    ],
                    [
                        -1.6119436168082757e-06,
                        1.0756450308235799e-07,
                        -8.505542155035073e-07,
                        1.1778743100876454e-06,
...
class HashEmbedTest(parameterized.TestCase):
    ...
    def test_hash_embedder_4d(self):
        ...
        self.assertSequenceEqual(
            outputs.shape, (batch_size, seq_len, another_dim, features)
        )
...
class NgramHashEmbedTest(parameterized.TestCase):
    ...
    def test_hash_embedder(self, batch_sizes, use_segment_ids):
        ...
        segment_ids = (
            np.tile([[0] * 5 + [1] * 3], (*batch_sizes, 1)) if use_segment_ids else None
        )
        outputs, variables = embedder.init_with_output(
            key, ids, segment_ids=segment_ids
        )
        ...
        self.assertSameStructure(
            param_shapes,
            {
                "1gram_hash_embed_table_0": {"embedding": expected_table_shape},
                "1gram_hash_embed_table_1": {"embedding": expected_table_shape},
                "3gram_hash_embed_table_0": {"embedding": expected_table_shape},
                "3gram_hash_embed_table_1": {"embedding": expected_table_shape},
                "4gram_hash_embed_table_0": {"embedding": expected_table_shape},
                "4gram_hash_embed_table_1": {"embedding": expected_table_shape},
            },
        )
    ...
    def test_packing_correctness(self, batch_sizes):
        ...
        outputs1, variables = embedder.init_with_output(
            key, ids1, segment_ids=segment_ids
        )
