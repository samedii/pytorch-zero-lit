...
import numpy as np
from lit.t5x import models as t5x_models
...
class GinConfigsTest(parameterized.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.root = os.path.join(
            absltest.get_default_test_srcdir(), "flaxformer/t5x/configs/longt5"
        )
    ...
    @parameterized.parameters(
        "longt5_1_1_flaxformer.gin", "longt5_1_1_transient_global_flaxformer.gin"
    )
