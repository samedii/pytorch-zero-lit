...
class HAttention1DTest(parameterized.TestCase):
    ...
    def test_large_num_clusters(self):
        ...
        result, _ = attention_module.init_with_output(rng, inputs_q, padding_mask=None)
    ...
    @parameterized.named_parameters(
        ...
        dict(
            testcase_name="decoder_rpb_multihead", use_rpb=True, use_multihead_rpb=True
        ),
    )
    ...
    @parameterized.named_parameters(
        ...
        dict(
            testcase_name="encoder_rpb_multihead", use_rpb=True, use_multihead_rpb=True
        ),
    )
