...
from lit.flaxformer.architectures.perceiver_ar import (
    perceiver_ar_architecture,
)
from lit.flaxformer.architectures.t5 import t5_architecture_test_utils
...
def test_make_decoder_only1(num_latents: int) -> perceiver_ar_architecture.DecoderOnly:
...
def make_parallel_fused_transformer_config(
    ...
    def _embedder():
        return t5_architecture_test_utils.make_token_emb1(2_000, dtype, num_features)
