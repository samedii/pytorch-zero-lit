...
class EncoderDecoderModelTest(parameterized.TestCase):
    @parameterized.named_parameters(
        dict(
            ...
            shapes={"encoder_input_tokens": [1, 512], "decoder_input_tokens": [1, 62]},
            types=None,
        ),
        dict(
            testcase_name="int32",
    ...
    def test_prompt_with_targets(self, prompt_with_targets):
        ...
        batch = {
            ...
            "decoder_input_tokens": np.full(
                [batch_size, max_decode_len], 2, dtype=np.int32
            ),
        }
    ...
    def test_train_transformer_wmt(self):
        ...
        partitioner = partitioning.PjitPartitioner(num_partitions=1, use_cpu_pjit=True)
