...
from lit.vit_jax import test_utils
from lit.vit_jax import train
from lit.vit_jax.configs import common
from lit.vit_jax.configs import models
            ...
            if dataset_source == "tfds":
                ...
                for mode in ("train", "test"):
                    for class_name in ("test1", "test2"):
                        for i in range(8):
                            path = os.path.join(
                                config.dataset, mode, class_name, f"{i}.jpg"
                            )
