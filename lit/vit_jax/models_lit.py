...
from lit.vit_jax import models_vit
from lit.vit_jax import preprocess

from lit.flaxformer.architectures.bert import bert
from lit.flaxformer.architectures.bert import configs
...
class LitModel(nn.Module):
    ...
    def get_tokenizer(self):
        ...
        return preprocess.get_tokenizer(self.pp.tokenizer_name)(
            vocab_path=self.vocab_path, max_len=self.pp.max_len
        )
    ...
    def __call__(self, *, images=None, tokens=None):
        ...
        if tokens is not None:
            ...
            text_model = model_class(
                **{"num_classes": out_dims[1], **(self.text or {})}, name="txt"
            )
